...
class DataImporterTests {
    ...
    fun `should read data`() {
        ...
        every { objectMapper.readValue(any<ByteArrayInputStream>(), any<Class<Array<Pokemon>>>()) } returns pokemons.toTypedArray()

        val result = dataImporter.read("pokemons.json", Pokemon::class.java)

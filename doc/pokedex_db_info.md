--- START OF FILE pokedex_db_info.md ---
...
erDiagram
    ...
    Region ||--o{ Generation : "1:N gerações"
    Generation ||--o{ Pokemon : "1:N introduz Pokémon"
    Generation ||--o{ Ability : "1:N introduz habilidades"
    Species ||--o{ Pokemon : "1:N define espécie"
    Pokemon ||--|| Stats : "1:1 possui stats"
    Pokemon ||--o{ PokemonType : "1:N tipos"
    Type ||--o{ PokemonType : "1:N usado por Pokémon"
    Pokemon ||--o{ PokemonAbility : "1:N habilidades"
    Ability ||--o{ PokemonAbility : "1:N usada por Pokémon"
    Pokemon ||--o{ PokemonEggGroup : "1:N grupos de ovos"
    EggGroup ||--o{ PokemonEggGroup : "1:N contém Pokémon"
    EvolutionChain ||--o{ EvolutionLink : "1:N links"
    Pokemon ||--o{ EvolutionLink : "1:N participa"
    PokemonWeakness ||--|| Pokemon : "N:N fraquezas"
    PokemonWeakness ||--|| Type : "N:N tipos fracos"